  ...
  return (
    ...
    >
      <div className={styles.modal}>
        <button className={styles.closeBtn} onClick={onClose} aria-label="Close rating modal">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className={styles.ratingSection}>
          ...
          <div className={styles.stars} role="radiogroup" aria-label="Service quality rating">
            {[1, 2, 3, 4, 5].map((star) => (
              <button
                type="button"
                key={star}
                ...
                aria-pressed={serviceRating === star}
              >
                ★
              </button>
            ))}
        ...
        <div className={styles.ratingSection}>
          ...
          <div
            ...
            role="radiogroup"
            aria-label="Delivery and punctuality rating"
          >
            {[1, 2, 3, 4, 5].map((star) => (
              <button
                type="button"
                ...
                aria-label={`${star} star${star > 1 ? 's' : ''}`}
                aria-pressed={deliveryRating === star}
              >
                ★
              </button>
            ))}
