        ...
        <div className={styles.container}>
          ...
          <section className={styles.hero}>
            ...
            <p className={styles.heroSubtitle}>
              Your surplus can be someone else&apos;s survival. Connect with verified NGOs and share
              the joy of giving.
            </p>
            ...
            <div className={styles.activityFeed}>
              {RECENT_ACTIVITY.map((act) => (
                <div
                  ...
                  style={{ animationDelay: `${act.id * 0.15}s` }}
                >
                  <Avatar name={act.user} size="sm" color="amber" />
                  <div className={styles.activityInfo}>
                    <span className={styles.activityBold}>{act.user}</span> donated{' '}
                    <span className={styles.activityBold}>{act.item}</span>
                    <br />
