...
const services = [
  {
    emoji: '📱',
    title: 'Electronics',
    desc: 'Phones, laptops & gadget repairs',
    color: '#3B82F6',
    bg: '#EFF6FF',
    href: '/repair',
  },
  {
    emoji: '🏠',
    title: 'Appliances',
    desc: 'AC, washing machine, TV repairs',
    color: '#10B981',
    bg: '#ECFDF5',
    href: '/repair',
  },
  {
    emoji: '🛵',
    title: 'Bike / Car',
    desc: 'Puncture, breakdown & service',
    color: '#F97316',
    bg: '#FFF7ED',
    href: '/repair',
  },
  {
    emoji: '🔧',
    title: 'Home Services',
    desc: 'Electrical, plumbing & cleaning',
    color: '#8B5CF6',
    bg: '#F5F3FF',
    href: '/repair',
  },
  {
    emoji: '⚙️',
    title: 'Tools',
    desc: 'Rent or repair power tools',
    color: '#F59E0B',
    bg: '#FFFBEB',
    href: '/repair',
  },
  {
    emoji: '✨',
    title: 'Donate',
    desc: 'Share surplus with those in need',
    color: '#EF4444',
    bg: '#FEF2F2',
    href: '/donate',
  },
...
const steps = [
  {
    ...
    desc: 'Pick from Electronics, Appliances, Home Services and more.',
  },
  {
    num: '02',
    icon: '🛵',
    title: 'Track in Real Time',
    desc: 'Watch your technician arrive and work with live status updates.',
  },
  {
    num: '03',
    icon: '✅',
    title: 'Pay When Done',
    desc: 'Pay securely via UPI, card or cash — only after satisfaction.',
  },
];
...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      'Got my laptop screen fixed in 3 hours. The technician was super professional and the app kept me updated throughout!',
  },
  {
    initials: 'PM',
    name: 'Priya M.',
    ...
    rating: 5,
    quote:
      'Donated 30 meal packets through Dosth to Robin Hood Army. The whole process was so seamless. Truly your friend!',
  },
  {
    initials: 'KR',
    name: 'Karthik R.',
    ...
    rating: 5,
    quote:
      'AC repair booked at 10am, technician arrived by 11:30. Priced fairly and completed within 2 hours. 10/10!',
  },
];
          ...
          <div className={styles.heroContainer}>
            <div className={styles.heroLeft}>
              ...
              <h1 className={styles.heroTitle}>
                Your City&apos;s Most Trusted{' '}
                <span className={styles.heroAccent}>Repair &amp; Care</span> Network
              </h1>
              <p className={styles.heroSubtitle}>
                Dosth connects you with verified technicians, community donors, and real-time
            ...
            <div className={styles.servicesGrid}>
              {services.map((s, i) => (
                <Link
                  ...
                  style={{ '--tile-color': s.color, '--tile-bg': s.bg }}
                >
        ...
        <section className={styles.ctaBanner}>
          <div className={styles.ctaBannerInner}>
            ...
            <p className={styles.ctaBannerSub}>
              Join 50,000+ happy users today. Your friend is waiting.
            </p>
            <div className={styles.ctaBannerButtons}>
              <Link href="/repair" className={styles.ctaBannerPrimary}>
                Start a Repair →
              </Link>
              <Link href="/donate" className={styles.ctaBannerSecondary}>
                Donate Surplus
              </Link>
            </div>
          </div>
