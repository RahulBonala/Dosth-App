        ...
        <div className={styles.card}>
            ...
            {authType === 'phone' ? (
                  ...
                  <div className={styles.otpWrapper}>
                    ...
                    <div className={styles.resendRow}>
                      ...
                      <button
                        ...
                        onClick={() => showToast({ type: 'info', message: 'OTP resent!' })}
                      >
                        Resend OTP
                      </button>
                    </div>
              ...
              <>
                ...
                <button
                  ...
                  onClick={() =>
                    showToast({ type: 'info', message: 'Reset link sent to your email.' })
                  }
                >
                  Forgot Password?
                </button>
          ...
          <div className={styles.socialGrid}>
            <button
              ...
              onClick={() => showToast({ type: 'info', message: 'Google login simulation' })}
            >
            ...
            <button
              className={styles.socialBtn}
              onClick={() => showToast({ type: 'info', message: 'Apple login simulation' })}
            >
              <svg className={styles.socialIcon} viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.05 20.28c-.98.95-2.05 1.78-3.1 1.76-1.06-.02-1.4-.64-2.63-.64-1.21 0-1.6.62-2.6.64-1.04.02-2.03-.73-3.08-1.74-2.14-2.06-3.76-5.83-3.76-8.91 0-4.88 3.07-7.46 6-7.46 1.07 0 2.01.4 2.65.4.63 0 1.72-.46 2.94-.46 1.28 0 2.8.53 3.82 1.95-2.58 1.54-2.16 5.17.47 6.44-1.07 2.4-2.73 6.04-3.71 7.02zM12.03 5c-.02-2.31 1.9-4.22 4.15-4.5.15 2.54-2.05 4.67-4.15 4.5z" />
              </svg>
              Apple
            </button>
          </div>
