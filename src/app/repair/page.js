...
const services = [
  { id: 1, title: 'Electronics', category: 'Electronics', desc: 'Phone, laptop, and gadget repairs.' },
  { id: 2, title: 'Appliances', category: 'Appliances', desc: 'AC, washing machine, and TV repairs.' },
  { id: 3, title: 'Bike / Car', category: 'Vehicle', desc: 'Puncture, breakdown, and general service.' },
          ...
          <div className={styles.container}>
            ...
            {filtered.length === 0 ? (
              <div className={styles.emptyState}>
                ...
                <button className={styles.clearBtn} onClick={() => { setSearch(''); setActiveCategory('All'); }}>
                  Clear Filters
                </button>
              </div>
            ) : (
