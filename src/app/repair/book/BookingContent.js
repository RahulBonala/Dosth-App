        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.providerTabs}>
              <button
                type="button"
                className={`${styles.providerTab} ${!manualShop ? styles.providerTabActive : ''}`}
                onClick={() => setManualShop(false)}
              >
                Best Match
              </button>
              <button
              ...
              <div className={styles.providerList}>
                {PROVIDERS.map((p, idx) => (
                  ...
                  >
                    ...
                    <div
                      className={`${styles.providerRadio} ${selectedProvider === idx ? styles.providerRadioActive : ''}`}
                    ></div>
                  </div>
                ))}
              </div>
          ...
          <div className={styles.estimateBanner}>
            ...
            <div>
              <span className={styles.estimateText}>
                Estimated: ₹{400 + urgencySurcharge} – ₹{800 + urgencySurcharge}
              </span>
